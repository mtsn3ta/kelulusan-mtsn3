...
class SettingResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pengaturan Kelulusan';

protected static ?string $modelLabel = 'Pengaturan Kelulusan';

protected static ?string $pluralModelLabel = 'Pengaturan Kelulusan';
